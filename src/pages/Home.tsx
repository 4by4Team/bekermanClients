  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Cloud 10 - Middle Center-Left - Purple */}
      ...
      <div className="relative z-10 container mx-auto px-4 pt-32 pb-20">
        ...
        <section className="text-center max-w-5xl mx-auto mb-20">
          ...
          <div className="text-xl md:text-2xl text-gray-600 leading-relaxed mb-12 space-y-6 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <p className="max-w-4xl mx-auto">
              ...
              <br />
              כאן תמצאו מסלולי למידה מקצועיים ומעמיקים שיעניקו לכם את הכלים הנחוצים 
              לשינוי אמיתי ומתמשך בחייכם.
            </p>

            <p className="max-w-4xl mx-auto">
              המומחים שלנו פיתחו תוכניות לימוד ייחודיות המבוססות על המחקרים העדכניים ביותר 
              בתחומי התזונה, הפיזיותרפיה והבריאות הכוללת. 
              <span className="font-semibold text-violet-600"> אנחנו מאמינים שכל אדם זכאי לחיים בריאים ומלאים.</span>
            </p>

            <p className="max-w-4xl mx-auto">
              הקהילה שלנו מונה אלפי בוגרים שכבר חוו שינוי משמעותי בחייהם - 
              הם הוכיחו שעם הידע הנכון, הנחיה מקצועית וקהילה תומכת, 
        ...
        {/* Features Section - Enhanced with cloudy background and elegant borders */}
